...
namespace ProvaPub.Controllers
{
	...
	public class Parte4Controller :  ControllerBase
	{
        ...
        [HttpGet("CanPurchase")]
		public async Task<bool> CanPurchase(int customerId, decimal purchaseValue,CancellationToken cancellation)
		{

			return await _customerService.CanPurchase(customerId, purchaseValue, cancellation);
		}
	}
}
